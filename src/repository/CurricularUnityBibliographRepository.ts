...
export { CreateBibliographCurricularUnity, ReadAllBibliographCurricularUnitys, ReadBibliographCurricularUnity, UpdateBibliographCurricularUnity, DeleteBibliographCurricularUnity };