...
export { CreateKnowledgeCurricularUnity, ReadAllKnowledgeCurricularUnitys, ReadKnowledgeCurricularUnity, UpdateKnowledgeCurricularUnity, DeleteKnowledgeCurricularUnity };